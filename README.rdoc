...
=== Command line options
    ...
    --vm-cpus CPUS => The Virtual Machine cpus (default: 1)
    ...
    -N network[,network..] | --vm-network => Network where nic is attached to (default: 'VM Network')
...
=== Command line options
    ...
    --force-delete YES|NO => Do note confirm the deletion if yes (default: no)
